...
def tag_edit_distance_vsm(analysis_nids=[], tag_table='', out_table='', target_nids=None, debug=False, save_limit=None):
    con = connect_db()
    cur = con.cursor()
    time_start = time()
...
if __name__ == '__main__':
    ...
    # debug = True
    # tag_edit_distance_vsm(nids, tag_table='novel_base_tag',
    #                       out_table='similar_base_tag', debug=debug)
    # tag_edit_distance_vsm(nids, tag_table='novel_description_tag',
